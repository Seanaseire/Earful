   ...
   <body>
      ...
      <div id="main">
         <div id="Right">
            ...
            <img id="contactimg"src="Images/Media/about.png"style="width:100%;">
            <div id="contact">
               <div id="cright">
               ...
               <div id="cleft">
               <h4 >About Earful:</h4>
               <p>Earful is a social media and podcasting site. <br> Earful was created in 2019 in Ireland as a social media based around podcasts as a platform for both listeners and creators to share and discuss podcasts.</p>
